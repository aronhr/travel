        ...
        <div class="fixed bottom-0 w-full z-50 " v-if="!isNavbarHidden">
            <div class="flex flex-row w-full bg-dark text-gray py-4 z-10 h-20 items-center overflow-hidden">
                <div class="flex flex-row justify-between w-full text-center">
                    ...
                    <router-link to="/coffee" class=" group w-1/3 border-l-2 border-white" :class="computeLinkClass('coffee')">
                      <i class="pi pi-coffee group-hover:scale-105 group-hover:text-white transition duration-75" style="font-size: 1.5rem" />
                    </router-link>
